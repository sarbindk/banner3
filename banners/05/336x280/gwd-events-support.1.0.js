...
gwd.actions.events.getElementById = function(id) {
    ...
    if (!element) {
        var pageDeck = document.querySelector("[is=gwd-pagedeck]");
        if (pageDeck) {
...
gwd.actions.timeline.timelineAnimationRegistry = {};
...
gwd.actions.timeline.gotoAndPlay = function(id, animClass) {
    ...
    var className = gwd.actions.timeline.timelineAnimationRegistry[id];
    ...
    gwd.actions.timeline.timelineAnimationRegistry[id] = animClass;
    return true
};
...
gwd.actions.timeline.gotoAndPlayNTimes = function(id, animClass, count, eventName) {
    ...
    if (typeof el[counterName] == "undefined") {
        el[counterName] = 0
    }
    if (el[counterName] < count) {
        gwd.actions.timeline.gotoAndPlay(id, animClass)
    }
    el[counterName]++
};
gwd.actions.gwdDoubleclick = gwd.actions.gwdDoubleclick || {};
gwd.actions.gwdDoubleclick.exit = function(receiver, exitId, url, opt_collapseOnExit, opt_pauseMedia) {
    gwd.actions.events.getElementById(receiver).exit(exitId, url, opt_collapseOnExit, opt_pauseMedia)
}